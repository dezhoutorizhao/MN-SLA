...
DEFAULT_PACKET_DIR = ROOT / "outputs" / "human_validation_overlap_20260601"


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Analyze completed MN-SLA 90-item overlap IAA annotations.")
    parser.add_argument(
        "--annotations",
        nargs="+",
        required=True,
...
def main(argv: list[str] | None = None) -> None:
    ...
    report = analyze_human_annotations(
        ...
        config=HumanAnnotationAnalysisConfig(
            ...
            min_complete_cells_per_regime=10,
            min_total_complete_cells=30,
    ...
    print(f"Wrote overlap IAA analysis to {args.output_dir}")
